...
//         // 대답
//         $('#nangjangbot-conversationContainer').append(
//             `<div class="nangjangbot-chatBotMsg">
//                         <img src="/image/nangjangbot/apple.png" class="nangjangbot-mascot">
//                         <div class="botMsgBox">남은 돼지 목살과 사과로 일식 느낌의 요리를 만들 수 있는 좋은 방법은 간단한 돼지 목살 사과 덮밥입니다.
...
//       이 요리는 간단하면서도 달콤하고 짭짤한 맛이 어우러져 일식 느낌을 낼 수 있을 거예요.</div>
//                     </div>`)
//
//
//         // 인풋창 비우기
