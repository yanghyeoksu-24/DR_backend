...
//    옵셔널 클래스는 NPE를 방어하기 위해 사용한다
    ...
    Optional<Long> selectEmail(@Param("loginEmail") String loginEmail, @Param("userPw") String userPw);

    Optional<UserSessionDTO> selectLoginInfo(@Param("loginEmail") String loginEmail, @Param("userPw") String userPw);
}